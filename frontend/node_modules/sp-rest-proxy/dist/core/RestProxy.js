                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        bodyParserRaw = bodyParser.raw({
                            type: function (_req) { return true; },
                        ...
                        upCallback = function (server, context, settings, callback) {
                            _this.logger.info("SharePoint REST Proxy has been started on " + context.proxyHostUrl);
