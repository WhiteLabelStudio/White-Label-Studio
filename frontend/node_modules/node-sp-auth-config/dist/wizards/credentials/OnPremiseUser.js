...
var wizard = function (authContext, answersAll) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var onPremiseUserCredentials, promptFor, username, noDomain, answers;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    onPremiseUserCredentials = authContext.authOptions;
                    promptFor = [
                        {
                            name: 'username',
                            message: 'User name',
                ...
                case 1:
                    ...
                    answersAll = __assign(__assign({}, answersAll), { username: username });
                    noDomain = false;
