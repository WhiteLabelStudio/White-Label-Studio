...
var wizard = function (authContext, answersAll) {
    if (answersAll === void 0) { answersAll = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        var strategyWizard;
        return __generator(this, function (_a) {
            strategyWizard = {
                OnPremiseAddinCredentials: OnPremiseAddin_1.default,
                OnpremiseUserCredentials: OnPremiseUser_1.default,
                OnpremiseTmgCredentials: OnPremiseTmg_1.default,
                OnpremiseFbaCredentials: OnPremiseFba_1.default,
                OnlineAddinCredentials: OnlineAddin_1.default,
                UserCredentials: OnlineUser_1.default,
                AdfsUserCredentials: AdfsUser_1.default,
                OnDemandCredentials: OnDemand_1.default
            }[answersAll.strategy];
            if (strategyWizard) {
                return [2, strategyWizard(authContext, answersAll)];
            }
            return [2, answersAll];
        });
    });
